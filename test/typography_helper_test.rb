...
class TypographyHelperTest < Test::Unit::TestCase
	...
	def test_rubyshirt
		assert_equal '<span class="caps">OU</span> <span class="amp">&amp;</span>&nbsp;<span class="caps">UT</span>', rubyshirt(@test_string1)
		assert_equal '<span class="quo">&#8216;</span>Meeting at 9&nbsp;<span class="caps">P.M.</span>&#8217;', rubyshirt(@test_string2)
		assert_equal '<p>eat at&nbsp;<a class="some_class">joe&#8217;s</a></p>', rubyshirt(@test_string3)
		assert_equal '<h2>Standard <span class="caps">HTML</span> Header Tag &#8211;&nbsp;fun</h2>', rubyshirt(@test_string4)
		assert_equal '<h1>this is <span class="caps">THE</span>&nbsp;title</h1><p><span class="dquo">&#8220;</span>this is a&nbsp;paragraph&#8221;</p>', rubyshirt(@test_string5)
	end
